...
import {
  HolidayManagement,
  HolidayForm,
} from "./modules/leave-management-system/holiday-management";
                          ...
                          <BrowserRouter>
                            <Routes>
                              ...
                              >
                                ...
                                />
                                {/* Leave Management routes - Nested under /leave-holiday */}
                                <Route
                                  path="/leave-holiday"
                                  element={<LeaveHoliday />}
                                />
                                <Route
                                  path="/leave-holiday/leave-settings"
                                  element={<LeaveSettings />}
                                />
                                <Route
                                  path="/leave-holiday/leave-configuration-form"
                                  element={<LeaveConfigurationFormPage />}
                                />
                                <Route
                                ...
                                />
                                <Route
                                  path="/incentives-bonuses"
                                  element={<IncentivesBonuses />}
                                />
                                ...
                                />
                                <Route
                                  path="/offers-preboarding"
                                  element={<OffersPreboarding />}
                                />
                                <Route
                                  path="/onboarding"
                                  element={<OnboardingChecklists />}
                                />
                                ...
                                />
                                <Route
                                  path="/my-attendance-leave"
                                  element={<MyAttendanceLeave />}
                                />
                                <Route
                                  path="/my-payslips"
                                  element={<MyPayslips />}
                                ...
                                />
                                <Route
                                  path="/expense-management/settings"
                                ...
                                />
                                <Route
                                  path="/expense-management/approve/:id"
                                  element={<ExpenseApprovalPage />}
                                />
                                <Route
                                  path="/expense-management/intimation/new"
                                  element={<IntimationForm />}
                                />
                                <Route
                                  path="/expense-management/intimation/edit/:id"
                                  element={<IntimationForm />}
                                />
                                <Route
                                  path="/expense-management/intimation/approve/:id"
                                  element={<IntimationApprovalPage />}
                                />
                                <Route
                                ...
                                <Route
                                  ...
                                  element={<TasksTimesheets />}
                                />
                                <Route
                                  path="/project-attendance"
                                  element={<ProjectAttendance />}
                                />
                                ...
                                <Route
                                  path="/room-management/browse"
                                  element={<RoomBrowse />}
                                />
                                <Route
                                  path="/room-management/booking-form"
                                  element={<BookingPage />}
                                />

                                {/* Admin-only routes */}
                                <Route
                                  path="/room-management/room-form"
                                  element={<RoomForm />}
                                />
