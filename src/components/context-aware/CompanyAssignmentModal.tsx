 ...
 * Reusable modal for selecting/managing companies across different features
 * Used for holidays, expenses, and other multi-company scenarios
 */
...
export const CompanyAssignmentModal: React.FC<CompanyAssignmentModalProps> = ({
  ...
  description = 'Select the companies this applies to',
}) => {
